...
public class PreguntaQueUsar {
     ...
     * @param estado 
     */
    public PreguntaQueUsar(String pregunta, String imagen, Set<RespuestaQueUsar> respuestas, int nivel, String personalizado, int id, int idPregunta, String estado){
     ...
     */
    public Set<RespuestaQueUsar> getRespuestas() {
        return respuestas;
    }
     ...
     */
    public void setRespuestas(Set<RespuestaQueUsar> respuestas) {
        this.respuestas = respuestas;
    }
