...
public class PersonalSalud {
     ...
     * @param correo 
     */
    public PersonalSalud(Integer id, String nombres, String apellidos, String documentoIdentidad, String nombreUsuario, String password, String tipoDocumento, String correo, String rol){
        this.id = id;
