var diagramaMusicoterapia = (function () {
    return{
        cargarAcertadas(datos, fechas) {
            var chart = $('#preguntasAcertadasMusicoterapia').highcharts({
                chart: {
                    type: 'column'
                },
                credits: {
        ...
        cargarErroneas(datos, fechas) {
            var chart = $('#preguntasErroneasMusicoterapia').highcharts({
                chart: {
                    type: 'column'
                },
                credits: {
        ...
        cargarTiempo(datos, fechas) {
            var chart = $('#tiempoJugadoMusicoterapia').highcharts({
                chart: {
                    type: 'column'
                },
                credits: {
        ...
        cargarNivelMaximo(datos, fechas) {
            var chart = $('#nivelMaximoMusicoterapia').highcharts({
                chart: {
                    type: 'column'
                },
                credits: {
