        ...
        validarRespuesta: function (Nombre) {
            ...
            if (respuesta[0].opcion === Nombre) {
                ...
                if (preguntasCorrectasTemporales > cantidaPreguntasPorNivel && nivel < nivelMaximo) {
                    ...
                    appGaleria.mostrarEstadisticas();
                    appGaleria.iniciarNivel();
                }
                preguntasCorrectas++;
...
//            console.log((fechaFin - horaInicio) / 60000);
        ...
        mostrarEstadisticas: function () {
            alert("Tiempo Jugado: " + appGaleria.traerTiempoJugado() + ". Preguntas Correctas: " + preguntasCorrectas + ". Preguntas Erroneas: " + preguntasErroneas + " . Nivel Máximo: " + nivelMaximoAlcanzado);
            console.info("Tiempo Jugado: " + appGaleria.traerTiempoJugado() + ". Preguntas Correctas: " + preguntasCorrectas + ". Preguntas Erroneas: " + preguntasErroneas + " . Nivel Máximo: " + nivelMaximoAlcanzado);
        },
        salir() {
            if ("S" === sessionStorage.getItem("esTemporal")) {
                ...
                var tiempoJugado = appGaleria.traerTiempoJugado();
...
//                console.info(tiempoJugado);
                var promesa = apiclientGaleria.enviarResultados(sessionStorage.getItem("id"), anio + "/" + mes + "/" + dia, preguntasCorrectas, preguntasErroneas, tiempoJugado, nivelMaximoAlcanzado);
                promesa.then(
                        function () {
                            window.location.href = "/menuPaciente.html";
                        },
...
function habilitarTodosLosBotones() {
    ...
    $("#idBtn5050").attr("onclick", "appGaleria.ayuda5050()");
}
